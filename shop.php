...
<div class="breadcrumb-area gray-bg">
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                <li><a href="<?php echo FRONT_SITE_PATH?>shop" style="color:red;">Shop</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-9">
                <div class="shop-topbar-wrapper">
                    <div class="product-sorting-wrapper">
                        <div class="product-show shorting-style" style="margin-top:10px;">
                            <?php
								foreach($arrType as $list){
									...
									?>
                            <?php echo strtoupper($list)?> <input type="radio" class="dish_radio"
                                <?php echo $type_radio_selected?> name="type" value="<?php echo $list?>"
                                onclick="setFoodType('<?php echo $list?>')" />&nbsp;
                            <?php
								}									
								?>
                        </div>
                        <div class="product-show search_box_main">
                            <input type="textbox" id="search" class="search_box" value="<?php echo $search_str?>" />
                            <input class="search_box seahc_box_btn" type="button" value="Search"
                                onclick="setSearch()" />
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-width col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-30">
                                <div class="product-wrapper">
                                    <div class="product-img">
                                        <a href="food_details.php?id=<?php echo $product_row['id']?>">
                                    ...
                                    <div class="product-content" id="dish_detail">
                                        <h4>
                                            <?php
                                                        ...
                                                        ?>
                                            <a href="javascript:void(0)" style="color:#0000A0;"><?php echo $product_row['dish'];
            ...
            <div class="col-lg-3">
                <div class="shop-sidebar-wrapper gray-bg-7 shop-sidebar-mrg">
                    <div class="shop-widget">
                        <h4 class="shop-sidebar-title shop_cat">All Categories</h4>

                        <div class="shop-catigory" style="color:#900C3F; font-weight:bold;">
                            <ul id="faq" class="category_list">

                                <li> <a href="<?php echo 
                                            FRONT_SITE_PATH?>shop"><u>Clear</u></a></li>
                                <?php 
                                    while($cat_row=mysqli_fetch_assoc($cat_res)){
                                        ...
                                        echo "<li><input $is_checked
                                        onclick=set_checkbox('".$cat_row['id']."') type='checkbox' class='cat_checkbox'
                                        name='cat_arr[]' value='".$cat_row['id']."'/>
                                        ".strtoupper($cat_row['category'])."</li>";
                                    }
                                    ?>
                            </ul>
                        </div>

                                ...
                                <tr>
                                    ...
                                    <td class="product-remove">
                                        <a href="javascript:void(0)"
                                            onclick="delete_cart('<?php echo $key?>','load')"><i class="fa fa-trash"
                        ...
                        <div class="col-lg-12">
                            <div class="cart-shiping-update-wrapper">
                                ...
                                <div class="cart-clear">
                                    ...
                                    <a href="<?php echo FRONT_SITE_PATH?>checkout">Place Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
